 ...
 */
final class ForbiddenNodeInBladeRuleTest extends RuleTestCase
{
    public function test(): void
    {
        $this->analyse([__DIR__ . '/Fixture/forbidden-functions.php'], [
    ...
    {
        return [__DIR__ . '/config/configured_forbidden_extension.neon'];
    }
