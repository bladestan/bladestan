 ...
 */
final class ForbiddenNodeInvalidFunctionsInBladeRuleTest extends RuleTestCase
{
    ...
    {
        return [__DIR__ . '/config/configured_forbidden_invalid_functions_extension.neon'];
    }
